...
class SupplierCreateView(SuccessMessageMixin, CreateView):
    ...
    success_message = "El proveedor a sido creado satisfactoriamente"
    template_name = "suppliers/edit_supplier.html"
    
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context["title"] = 'Nuevo Proveedor'
        context["savebtn"] = 'Agregar Proveedor'
        return context     
...
class SupplierUpdateView(SuccessMessageMixin, UpdateView):
    ...
    form_class = SupplierForm
    success_url = '/transactions/suppliers'
    success_message = "Los datos del proveedor se han actualizado correctamente"
    template_name = "suppliers/edit_supplier.html"
    ...
    def get_context_data(self, **kwargs):
        ...
        context["delbtn"] = 'Eliminar Proveedor'
        return context
...
class SupplierDeleteView(View):
    ...
    success_message = "El proveedor se ha eliminado correctamente"
    ...
    def post(self, request, pk):
        ...
        if formset.is_valid():
            ...
            for form in formset:                                                # for loop to save each individual form as its own object
                ...
                stock.save()
                billitem.save()
            messages.success(request, "Los repuestos obtenidos fueron registrados satisfactoriamente")
    ...
    def delete(self, *args, **kwargs):
        ...
        for item in items:
            ...
            if stock.is_deleted == False:
                ...
                stock.save()
        messages.success(self.request, "El comprobante de compra se ha eliminado satisfactoriamente")
    ...
    def post(self, request):
        ...
        if form.is_valid() and formset.is_valid():
            ...
            for form in formset:                                                # for loop to save each individual form as its own object
                ...
                stock.save()
                billitem.save()
            messages.success(request, "Los repuestos en salida fueron registrados correctamente")
    ...
    def delete(self, *args, **kwargs):
        ...
        for item in items:
            ...
            if stock.is_deleted == False:
                stock.quantity += item.quantity
                stock.save()
        messages.success(self.request, "El comprobante de salida fue eliminada satisfactoriamente")
...
class PurchaseBillView(View):
    ...
    def post(self, request, billno):
        ...
        if form.is_valid():
            ...
            billdetailsobj.save()
            messages.success(request, "Los detalles del comprobante se han modificado correctamente")
        context = {
            'bill'          : PurchaseBill.objects.get(billno=billno),
            'items'         : PurchaseItem.objects.filter(billno=billno),
            'billdetails'   : PurchaseBillDetails.objects.get(billno=billno),
