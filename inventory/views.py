...
class StockCreateView(SuccessMessageMixin, CreateView):                                 # createview class to add new stock, mixin used to display message
    ...
    success_message = "Stock a sido creado satisfactoriamente"                             # displays message when form is submitted

    def get_context_data(self, **kwargs):                                               # used to send additional context
        context = super().get_context_data(**kwargs)
        context["title"] = 'Nuevo Repuesto'
        context["savebtn"] = 'Agregar a la Lista de Inventario'
        return context       
...
class StockDeleteView(View):                                                            # view class to delete stock
    ...
    success_message = "Stock a sido eliminado satisfactoriamente"                             # displays message when form is submitted
